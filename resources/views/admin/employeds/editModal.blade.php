...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="addModalLabel">Edit Employeds</h4>
        </div>
        <div class="modal-body">
        	<div class="row">
        		<div class="col-md-6">
                    <div class="input-group mb-3">
                        <label>Employeds Name</label>
                      <input type="text" class="form-control" placeholder="Employeds Name" aria-label="Employeds Name" aria-describedby="basic-addon1">
                    </div><br>
        			<div class="input-group mb-3">
                        <label>Brand</label>
