...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="addModalLabel">Add New Employed</h4>
        </div>
        <div class="modal-body">
        	<div class="row">
        		<div class="col-md-6">
                    <div class="input-group mb-3">
                        <label>Employed Name</label>
                      <input type="text" class="form-control" placeholder="Employed Name" aria-label="Employed Name" aria-describedby="basic-addon1">
                    </div><br>
        			<div class="input-group mb-3">
                        <label>Brand</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-info btn-fill" data-dismiss="modal">Add Employed</button>
        </div>
    </div>
</div>