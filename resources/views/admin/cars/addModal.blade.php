...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="addModalLabel">Add New Car</h4>
        </div>
        	...
        	<div class="row">
        		<div class="col-md-6">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Car Name" aria-label="Car Name" aria-describedby="basic-addon1">
                    </div><br>
        			<div class="input-group mb-3">
                        <label>Brand</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-info btn-fill" data-dismiss="modal">Add Car</button>
        </div>
    </div>
</div>